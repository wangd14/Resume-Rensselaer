...
<body>
  ...
  <ul id="description">
    <li class="bringup">
        <b><span id="project1name"><?php echo $info_decoded["project1name"]; ?></span> <span id="job1dates"><?php echo $info_decoded["project1dates"]; ?></span></b> 
        <br>
        <ul class="description" id="job1des">
          <li id="job1des1"><?php echo $info_decoded["project1description"]; ?></li>
      </ul>
    </li>
    <br>

    <li>
      <b><span id="project2name"><?php echo $info_decoded["project2name"]; ?></span> <span id="job1dates"><?php echo $info_decoded["project2dates"]; ?></span></b> 
      <br>
      <ul class="description" id="job1des">
        <li id="job1des1"><?php echo $info_decoded["project2description"]; ?></li>
    </ul>
  </li>
